...
{
    public partial class Master_Unit : Form
    {
        ...
        {
            InitializeComponent();
            ComFunc.Language("Master_Unit.cs", this);
            setScreen();
        }
        ...
        private void setScreen()
        {
            try
            {
                string str = "SELECT UNIT_ID,UNIT_NAME FROM TB_M_UNIT";
                    ...
                    || true == chb_name.Checked)
                {
                    ...
                    if (true == chb_id.Checked)
                    {
                        str = str + " UNIT_ID LIKE '%" + txtSearch.Text + "%'";
                        b_first = false;
                    }
                    if (true == chb_name.Checked)
                    {
                        ...
                        str = str + " UNIT_NAME LIKE '%" + txtSearch.Text + "%'";
                        b_first = false;
                    }
                }
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                if ("" != s_selected)
                {
                    ...
                    {
                        string s_SQL = "DELETE FROM TB_M_UNIT" +
                                        " WHERE UNIT_ID = '" + s_selected + "'";
        ...
        private bool checkInput()
        {
            ...
            string str = "SELECT * FROM TB_M_UNIT WHERE UNIT_ID = '" + txtID.Text + "'";
            DataTable dt = ComFunc.ConnectDatabase(str);
            if ("" == s_selected)
            {
                // new mode.
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                if (true == checkInput())
                {
                    ...
                    {
                        // new mode.
                        string s_cmd = "INSERT INTO TB_M_UNIT VALUES( " + "\n" +
                                       "'" + txtID.Text + "',\n" +
                                       "'" + txtName.Text + "',\n" +
                                       "'" + DateTime.Now + "',\n" +
                                       "'9999',\n" +
                        ...
                        {
                            string error_msg = @"System Error E1304";
                            ComFunc.WriteLogLocal(error_msg, "");
                        }
                    }
                    else
                    {
                        // edit mode.
                        string s_cmd = "UPDATE TB_M_UNIT SET " + "\n" +
                                       " UNIT_ID = '" + txtID.Text + "',\n" +
                        ...
                        if (null == ComFunc.ConnectDatabase(s_cmd))
                        {
                            string error_msg = @"System Error E1305";
                            ComFunc.WriteLogLocal(error_msg, "");
                        }
                    }
            ...
            {
                string error_msg = @"System Error E1306";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
            }
        }
        ...
        {
            ComFunc.GenerateDatagridview(dataGridView1, "UnitMaster", true);
        }

        private void btn_import_Click(object sender, EventArgs e)
        {
            ComFunc.ImportDatagridviewEXCEL(dataGridView1, "TB_M_UNIT");
            setScreen();
        }
    }
}
