...
{
    public partial class Master_Location : Form
    {
        ...
        {
            InitializeComponent();
            ComFunc.Language("Master_Location.cs", this);
            setScreen();
        }
        ...
        private void setScreen()
        {
            try
            {
                string str = "SELECT LOCATION_ID,LOCATION_NAME FROM TB_M_LOCATION";
                    ...
                    || true == chb_name.Checked)
                {
                    ...
                    if (true == chb_id.Checked)
                    {
                        str = str + " LOCATION_ID LIKE '%" + txtSearch.Text + "%'";
                        b_first = false;
                    }
                    if (true == chb_name.Checked)
                    {
                        ...
                        str = str + " LOCATION_NAME LIKE '%" + txtSearch.Text + "%'";
                        b_first = false;
                    }
                }
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                if ("" != s_selected)
                {
                    ...
                    {
                        string s_SQL = "DELETE FROM TB_M_LOCATION" +
                                        " WHERE LOCATION_ID = '" + s_selected + "'";
        ...
        private bool checkInput()
        {
            ...
            string str = "SELECT * FROM TB_M_LOCATION WHERE LOCATION_ID = '" + txtID.Text + "'";
            DataTable dt = ComFunc.ConnectDatabase(str);
            if ("" == s_selected)
            {
                // new mode.
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                if (true == checkInput())
                {
                    ...
                    {
                        // new mode.
                        string s_cmd = "INSERT INTO TB_M_LOCATION VALUES( " + "\n" +
                                       "'" + txtID.Text + "',\n" +
                                       "'" + txtName.Text + "',\n" +
                                       "'" + DateTime.Now + "',\n" +
                                       "'9999',\n" +
                    ...
                    {
                        // edit mode.
                        string s_cmd = "UPDATE TB_M_LOCATION SET " + "\n" +
                                       " LOCATION_ID = '" + txtID.Text + "',\n" +
                                       " LOCATION_NAME = '" + txtName.Text + "',\n" +
        ...
        {
            ComFunc.GenerateDatagridview(dataGridView1, "LocationMaster", true);
        }

        private void btn_import_Click(object sender, EventArgs e)
        {
            ComFunc.ImportDatagridviewEXCEL(dataGridView1, "TB_M_LOCATION");
            setScreen();
        }
    }
}
