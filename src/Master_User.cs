...
namespace BrightKeeper
{
    public partial class Master_User : Form
    {
        ...
        {
            InitializeComponent();
            ComFunc.Language("Master_User.cs", this);
            setScreen();
        }
        ...
        private void setScreen()
        {
            try
            {
                string str = "SELECT USER_ID,USER_NAME FROM TB_M_USER";
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                if ("" != s_selected)
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        {
                            string error_msg = @"System Error E1402";
            ...
            {
                string error_msg = @"System Error E1403";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
            }
        }
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                if (true == checkInput())
                {
                    if ("" == s_selected)
                    {
                        ...
                        {
                            string error_msg = @"System Error E1404";
                            ComFunc.WriteLogLocal(error_msg, "");
                        }
                    }
                    else
                    {
                        ...
                        if (null == ComFunc.ConnectDatabase(s_cmd))
                        {
                            string error_msg = @"System Error E1405";
                            ComFunc.WriteLogLocal(error_msg, "");
                        }
                    }
            ...
            {
                string error_msg = @"System Error E1406";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
            }
        }
