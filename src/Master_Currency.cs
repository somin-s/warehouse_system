...
{
    public partial class Master_Currency : Form
    {
        ...
        {
            InitializeComponent();
            ComFunc.Language("Master_Currency.cs", this);
            setScreen();
        }
        ...
        private void setScreen()
        {
            try
            {
                string str = "SELECT CURRENCY_NAME,RATE FROM TB_M_CURRENCY";
            ...
            {
                string error_msg = @"System Error E1901";
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                if ("" != s_selected)
                {
                    ...
                    {
                        string s_SQL = "DELETE FROM TB_M_CURRENCY" +
                                        " WHERE CURRENCY_NAME = '" + s_selected + "'";
                        if (null == ComFunc.ConnectDatabase(s_SQL))
                        {
                            string error_msg = @"System Error E1902";
            ...
            {
                string error_msg = @"System Error E1903";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
            }
        }
        ...
        private bool checkInput()
        {
            ...
            string str = "SELECT * FROM TB_M_CURRENCY WHERE CURRENCY_NAME = '" + txtID.Text + "'";
            DataTable dt = ComFunc.ConnectDatabase(str);
            if ("" == s_selected)
            {
                // new mode.
            ...
            else if (0 == ComFunc.ConvertDouble(txtName.Text))
            {
                MessageBox.Show(ComFunc.getMessage("E001"));
                txtName.Focus();
                return false;
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                if (true == checkInput())
                {
                    ...
                    {
                        // new mode.
                        string s_cmd = "INSERT INTO TB_M_CURRENCY VALUES( " + "\n" +
                                       "'" + txtID.Text + "',\n" +
                                       ComFunc.ConvertDouble(txtName.Text) + ",\n" +
                                       "'" + DateTime.Now + "',\n" +
                                       "'9999',\n" +
                                       "'" + DateTime.Now + "',\n" +
                                       "'9999')";
                        ...
                        {
                            string error_msg = @"System Error E1904";
                            ComFunc.WriteLogLocal(error_msg, "");
                        }
                    }
                    else
                    {
                        // edit mode.
                        string s_cmd = "UPDATE TB_M_CURRENCY SET " + "\n" +
                                       " CURRENCY_NAME = '" + txtID.Text + "',\n" +
                                       " RATE = " + ComFunc.ConvertDouble(txtName.Text) + ",\n" +
                                       " UPDATE_DATE = '" + DateTime.Now + "',\n" +
                                       " UPDATE_BY = '9999'\n" +
                                       " WHERE CURRENCY_NAME = '" + s_selected + "'";
                        if (null == ComFunc.ConnectDatabase(s_cmd))
                        {
                            string error_msg = @"System Error E1905";
                            ComFunc.WriteLogLocal(error_msg, "");
                        }
                    }
            ...
            {
                string error_msg = @"System Error E1906";
                ComFunc.WriteLogLocal(error_msg, ex.Message);
            }
        }
        ...
        {
            ComFunc.GenerateDatagridview(dataGridView1, "CurrencyMaster", true);
        }

        private void btn_import_Click(object sender, EventArgs e)
        {
            ComFunc.ImportDatagridviewEXCEL(dataGridView1, "TB_M_CURRENCY");
            setScreen();
        }
    }
}
