...
namespace BrightKeeper
{
    public partial class Master_Customer : Form
    {
        ...
        {
            InitializeComponent();
            ComFunc.Language("Master_Customer.cs", this);
            setScreen();
        }
        ...
        private void setScreen()
        {
            try
            {
                string str = "SELECT CUSTOMER_ID,CUSTOMER_NAME FROM TB_M_CUSTOMER";
                    ...
                    || true == chb_name.Checked)
                {
                    ...
                    if (true == chb_id.Checked)
                    {
                        str = str + " CUSTOMER_ID LIKE '%" + txtSearch.Text + "%'";
                        b_first = false;
                    }
                    if (true == chb_name.Checked)
                    {
                        ...
                        str = str + " CUSTOMER_NAME LIKE '%" + txtSearch.Text + "%'";
                        b_first = false;
                    }
                }
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                if ("" != s_selected)
                {
                    ...
                    {
                        string s_SQL = "DELETE FROM TB_M_CUSTOMER" +
                                        " WHERE CUSTOMER_ID = '" + s_selected + "'";
        ...
        private bool checkInput()
        {
            ...
            string str = "SELECT * FROM TB_M_CUSTOMER WHERE CUSTOMER_ID = '" + txtID.Text + "'";
            DataTable dt = ComFunc.ConnectDatabase(str);
            if ("" == s_selected)
            {
                // new mode.
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                if (true == checkInput())
                {
                    ...
                    {
                        // new mode.
                        string s_cmd = "INSERT INTO TB_M_CUSTOMER VALUES( " + "\n" +
                                       "'" + txtID.Text + "',\n" +
                                       "'" + txtName.Text + "',\n" +
                                       "'" + DateTime.Now + "',\n" +
                                       "'9999',\n" +
                    ...
                    {
                        // edit mode.
                        string s_cmd = "UPDATE TB_M_CUSTOMER SET " + "\n" +
        ...
        {
            ComFunc.GenerateDatagridview(dataGridView1, "CustomerMaster", true);
        }

        private void btn_import_Click(object sender, EventArgs e)
        {
            ComFunc.ImportDatagridviewEXCEL(dataGridView1, "TB_M_CUSTOMER");
            setScreen();
        }
    }
}
